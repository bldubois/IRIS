...
"""
Generate a synthetically observed dataset of full-cone observations.
...
hyper = hp.SEDIGISM_13C16O_FullCone_Test(min_snapshot_index=800, max_snapshot_index=None)
hyper.validate()
reader = ap.Reader(path='/path/to/training_data_1',
                   dataset_type=ap.SyntheticallyObservedDataset)

writer = ap.Writer(path='/path/to/full_cone_data',
                   snapshot_directory='/path/to/snapshot/directory',
                   ssh_key_path='/path/to/ssh/key/path',
