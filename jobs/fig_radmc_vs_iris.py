...
"""
Generate the RADMC3D-vs-IRIS comparison figure from the IRIS paper (DuBois et al., 2026).
"""
...
IRIS_DATASET_DIR = '~/IRIS/data/radmc_sidebyside'
RADMC3D_FILES_DIR = '~/IRIS/data/radmc3d_files'
RADMC3D_EXECUTABLE = '/path/to/radmc3d'
OBSERVE_IRIS = True
OBSERVE_RADMC = True
PEAK_13CO_ABUNDANCE = 4e-2
SIDE_BY_SIDE_PATH = '~/IRIS/output/radmc3d_vs_iris.png'
